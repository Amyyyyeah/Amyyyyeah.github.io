...
Hi, I’m a PhD candidate in Computer Science and Engineering at The Ohio State University, advised by [Andrew Perrault](https://aperrault.github.io/), with research interests in Large Language Models (LLMs), Reinforcement Learning (RL), and Multimodal Language–Speech Systems. My research focuses on understanding and evaluating AI behavior in human communication settings, with a particular focus on alignment, multimodal interaction, and challenges central to interactive and agentic AI.

## News
<div style="height: 200px; overflow-y: auto; padding: 10px; margin-bottom: 20px;">
<ul>
  <li><strong>[Jun. 2026]</strong> One paper accepted to <a href="https://interspeech2026.org/en-AU">Interspeech 2026</a>🎉</li>
  ...
  <li><strong>[Sep. 2024]</strong> Our paper ARES is accepted to EMNLP 2024 (Main).</li>
  <li><strong>[Aug. 2024]</strong> Honored to receive the <a href="https://cog.osu.edu/ccbs-summer-graduate-research-award-about">Summer Graduate Research Awards (Center for Cognitive and Brain Sciences)</a></li>
</ul>
</div>
